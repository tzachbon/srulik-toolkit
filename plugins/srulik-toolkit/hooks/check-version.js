...
const hint = "Srulik Toolkit skills: can-you-help, to-project, review-pro-max, create-plan, create-pr, stay-in-scope, agent-swarm, tdd, keep-it-simple, research, tour, show-me, stop-slop, pr-babysit, resolving-merge-conflicts, fix-ci. Read relevant skills and stay within the requested scope.";
